    ...
    return (
      <div className="relative w-full max-w-[700px] mx-auto group">
        <button
          ...
          className={`
        relative w-full bg-white border rounded-lg p-4 sm:p-6
        transition-all duration-200 cursor-grab active:cursor-grabbing shadow-md hover:shadow-lg
      ...
      `}
        ...
        {/* Delete button outside the main button */}
        <button
          type="button"
          onClick={(e) => {
            e.stopPropagation();
          ...
          className="absolute top-4 right-4 text-gray-400 hover:text-alert-red hover:bg-red-50 transition-all p-2 rounded-lg z-10"
