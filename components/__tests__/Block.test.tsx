...
describe('Block', () => {
  ...
  it('renders block with correct label', () => {
    render(
      <Block block={mockBlock} isSelected={false} onSelect={mockOnSelect} onDelete={mockOnDelete} />
    );
  ...
  it('shows selected state when isSelected is true', () => {
    render(
      <Block block={mockBlock} isSelected={true} onSelect={mockOnSelect} onDelete={mockOnDelete} />
    );
    const blockElement = screen.getByRole('button');
