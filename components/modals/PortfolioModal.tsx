...
export const PortfolioModal: React.FC<PortfolioModalProps> = ({ isOpen, onClose }) => {
  ...
  const isLoadingPrices =
    tokens.length > 0 && Array.from(prices.values()).every((p) => p === undefined);
                    ...
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="bg-gray-50 border-b border-gray-200 text-left">
                          <th className="px-6 py-3 font-mono text-xs text-gray-500 uppercase">
                            Asset
                          </th>
                      ...
                      <tbody className="divide-y divide-gray-100">
                        {isLoadingPrices && holdings.length > 0 ? (
                          ...
                          <tr>
                            <td
                              colSpan={4}
                              className="px-6 py-8 text-center text-sm font-mono text-gray-400"
                            >
                              No holdings
                            </td>
                          </tr>
